...
def place_bet(user_input):
    ...
    print("PLAYER BET ODDS: ", settings.bet_record[role]['odds'], '\n')
    bet_num("Please type the number you'd like to bet")

    if role in settings.bet_record:
        settings.bet_record[role]['record'].append((player_name, bet_num))
    else:
